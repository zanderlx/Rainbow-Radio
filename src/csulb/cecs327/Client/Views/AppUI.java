...
import csulb.cecs327.Client.Services.*;
import csulb.cecs327.Client.Services.CECS327InputStream;
...
public class AppUI extends JPanel {
    ...
    private static final String PAUSE_BUTTON_PATH = "/csulb/cecs327/Client/Resources/icon/Button-Pause-icon.png";
    private static final String PLAY_BUTTON_PATH = "/csulb/cecs327/Client/Resources/icon/Button-Play-icon.png";
            ...
            public void mouseClicked(MouseEvent e) {
                if (SwingUtilities.isRightMouseButton(e)) {
                    ...
                    try{
                        ...
                        updateProgressBar();
                        player.play();
                        playPauseButton.setIcon(new ImageIcon(getClass().getResource("/csulb/cecs327/Client/Resources/icon/Button-Pause-icon.png")));
                        int row = songInfoTable.getSelectedRow();
                        songLabel.setText((String)songInfoTable.getValueAt(row, 0));
                        artistLabel.setText((String)songInfoTable.getValueAt(row, 1));
                        fakeCurrent = row;
    ...
    private void playlistListMouseClicked(MouseEvent e) {
        {
            if(SwingUtilities.isRightMouseButton(e)){
                ...
                for (SongTableEntry entry : playlistModel.get(index).getListOfSongs()) {
...
//                songInfoPane.setViewportView(playlistView);
    ...
    private void initComponents() {
        ...
        logoutButton.setIcon(new ImageIcon(getClass().getResource("/csulb/cecs327/Client/Resources/icon/Logout-icon.png")));
        ...
        //---- addPlaylist ----
        addPlaylist.setIcon(new ImageIcon(getClass().getResource("/csulb/cecs327/Client/Resources/icon/Plus Icon.png")));
        addPlaylist.addActionListener(e -> addPlaylistActionPerformed(e));
        add(addPlaylist, "cell 13 20");

        //---- removePlaylist ----
        removePlaylist.setIcon(new ImageIcon(getClass().getResource("/csulb/cecs327/Client/Resources/icon/minus icon.png")));
        ...
        shuffleButton.setIcon(new ImageIcon(getClass().getResource("/csulb/cecs327/Client/Resources/icon/Shuffle.png")));
        ...
        previousButton.setIcon(new ImageIcon(getClass().getResource("/csulb/cecs327/Client/Resources/icon/Button-Back-icon.png")));
        previousButton.addActionListener(e -> previousButtonActionPerformed(e));
        add(previousButton, "cell 20 52,width 32:32:32");

        //---- playPauseButton ----
        playPauseButton.setIcon(new ImageIcon(getClass().getResource("/csulb/cecs327/Client/Resources/icon/Button-Play-icon.png")));
        playPauseButton.addActionListener(e -> playPauseButtonActionPerformed(e));
        add(playPauseButton, "cell 20 52,width 32:32:32");

        //---- nextButton ----
        nextButton.setIcon(new ImageIcon(getClass().getResource("/csulb/cecs327/Client/Resources/icon/Button-Forward-icon.png")));
