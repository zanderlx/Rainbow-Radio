...
import csulb.cecs327.DFS.Chord;
...
//            System.out.println(strMetaData);
    ...
    //TODO All these helper methods
    /**
     * Start the map reduce process of a certain file
     */
    public void runMapReduce(String fileInput, String fileOutput){

    }
    /**
     * Helper function: used to create a new file
     */
    public void createFile(String file,int interval, Long size){

    }
    /**
     * Helper functions : hash the file with md5 and add successor id + buld(page)
     */
    public void bulkTree(String fileOutput){
